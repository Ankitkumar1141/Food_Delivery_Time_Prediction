...
# Configure Scikit-learn transformer output format as pandas DataFrame
set_config(transform_output='pandas')

# Feature column definitions for pipeline transformations
...
# Define category hierarchies for ordinal encoding

traffic_order = ["low","medium","high","jam"]

distance_type_order = ["short","medium","long","very_long"]

# Configure preprocessing logger
...
def join_X_and_y(X: pd.DataFrame, y: pd.Series):
    # Merge features and target series along index
...
if __name__ == "__main__":
    ...
    # Initialize column transformation pipeline
    ...
    # Ingest interim train and test data, filtering unobserved entries
    ...
    # Partition dataset into feature matrix and target series
    ...
    # Execute transformations on training and testing feature sets
    ...
    # Reintegrate transformed feature matrices with target labels
    ...
    # Serialize fitted preprocessor pipeline artifact
