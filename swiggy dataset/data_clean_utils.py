...
def data_cleaning(data: pd.DataFrame):
    ...
    return (
        ...
        .assign(
            ...
            # Parse calendar timestamps and extract temporal attributes
            ...
            # Convert multi-delivery counts to floating point numeric
...
def perform_data_cleaning(data: pd.DataFrame, saved_data_path="swiggy_cleaned.csv"):
    ...
    # Save sanitized dataset to disk
    cleaned_data.to_csv(saved_data_path,index=False)
    
    

if __name__ == "__main__":
    # Source path for raw dataset
